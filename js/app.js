...
var questions = [
    ...
    [
        ...
        'Great, because I definitely value both family and work.  Having 5 children, I feel it\'s extremely important to set an example in all things I do.',
    ...
    [
        ...
        'That would be incorrect.  Being a cat family, we somehow ended up with one for each of my kids - so a total of 5!  Don\'t worry though, no litter box smells here.',
    ...
    [
        'The world of web development is full of different approaches to making websites.  Does having a developer who may not be fluent in your preference yet, but willing to learn it entice you?',
    ...
    'As mentioned earlier, I have 5 children - 3 boys, 2 girls.  Can you guess any of their names?'
]
...
for (var x = 0; x < questions.length - 2; x++) {
    ...
    while (parsedAnswer === null) {
        answer = prompt("Please use a Yes/No or a Y/N choice for answering this question.  " + questions[x][0]);
...
alert('Well, ' + nameOfVisitor + ', I\'m glad you\'re here!  Please check out my digital resume, and get in touch if you have any questions!');
var correctPercent = Math.floor((correctAnswers / questions.length) * 100);
alert('By the way, you matched my hopeful/expected responses at ' + correctPercent + '%, getting ' + correctAnswers + '/' + questions.length + ' correct!');
